...
def yaml2camera(calib_yaml):
    ...
    Parameters
    ----------
    calib_yaml : str Path to yaml file containing camera calibration data
...
if __name__ == "__main__":
    yamlcalib = rospy.get_param("/grasshopper_calibration_yaml")

    # Parse yaml file
    cameraInfoMsg = yaml2camera(yamlcalib)
    ...
    while not rospy.is_shutdown():
        publisher.publish(cameraInfoMsg)
        rate.sleep()
