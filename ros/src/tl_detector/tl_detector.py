...
class TLDetector(object):
    def __init__(self):
        ...
        if self.config['is_site']:
            model_path = 'models/frozen_inference_graph_site.pb'
        else:
            model_path = 'models/frozen_inference_graph_sim.pb'

        self.upcoming_red_light_pub = rospy.Publisher('/traffic_waypoint', Int32, queue_size=1)

        self.bridge = CvBridge()
        self.light_classifier = TLClassifier(model_path) # Passing the model path for traffic light classification
