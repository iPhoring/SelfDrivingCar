...
class WaypointUpdater(object):
    ...
    def loop(self):
        ...
        while not rospy.is_shutdown():
            rospy.loginfo_throttle(120, "self.pose[{}] and self.base_waypoints:[{}] ".format(self.pose,
                                                                                             self.base_waypoints))
            rospy.loginfo_throttle(120, "="*40)
    ...
    def generate_lane(self):
        ...
        # slicing to publish the points in front of the car -
    ...
    def decelerate_waypoints(self, waypoints, closest_idx):
        ...
        for i, wp in enumerate(waypoints):
            ...
            stop_idx = max(self.stopline_wp_idx - closest_idx - 2,
                           0)  # Two waypoints back from the line so front of the car stops at line.
